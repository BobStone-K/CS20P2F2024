...
public class Food {
	...
	//mutator method which takes number of burgers, and grams of fat, carbs, and fiber a singular burger has
	...
	//mutator method which takes number of salads, and grams of fat, carbs, and fiber a singular salad has
	...
	//mutator method which takes number of french fries, and grams of fat, carbs, and fiber a single serving of french fires has 
	...
	//mutator method which takes number of soda, and grams of fat, carbs, and fiber a singular soda has
	...
	//accessor method which returns the price variable which holds the dollar value of the user's order
	public double total() {
		return price;
	}
